...
#Creating animated barchart of top 10 incident types by year in California.
gun_robbery |>
  ...
  scale_y_continuous(expand = expansion(mult = c(0, 0.1))) +
  coord_flip() +
  labs(title = "Figure 8: Top 10 Incident Types in California, Year: {closest_state}",
       x = NULL,
       y = "Count") +
  theme_bw() +
...
```{r}
p <- ggplot(data.frame(correlation = result_pop$permuted_distribution), aes(x = correlation)) +
  geom_histogram(bins = 30, fill = "lightblue", color = "black") +
  geom_vline(xintercept = result_pop$observed_correlation, color = "red", linetype = "dashed", linewidth = 1.2) +
  labs(title = "Null Distribution of Permutation Correlations",
       ...
       subtitle = paste0("Observed correlation = ", round(result_pop$observed_correlation, 3),
